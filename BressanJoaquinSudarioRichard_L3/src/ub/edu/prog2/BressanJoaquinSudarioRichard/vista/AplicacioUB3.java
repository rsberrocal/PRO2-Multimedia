...
public class AplicacioUB3 {
    ...
    static private String[] descSubMenu3 = {"Reproduir un fitxer reproduible", "Reproduir tota la biblioteca", "Reproduir un album", "Activar/desactivar reproduccio continua", "Activar/desactivar reproduccio aleatoria", "Gestio reproduccio en curso"};
    static private String[] descSubMenu36 = {"Re-empren", "Pausa", "Atura", "Salta", "Sortir"};
    ...
    public void gestioSubMenu11 (Scanner sc){
        ...
        subMenu2.setDescripcions(descSubMenu11);
